...
_ASD_TABLES = {
    ...
    'sailing': {
        'f_nodes': np.array([1e-3, 1e-2, 3e-2, 0.1, 0.15, 0.3, 0.6, 1.0,
                              ...
                              200.0, 400.0, 1000.0]),
        'axis': {
            'x': np.array([2.2e-2, 2.0e-2, 1.8e-2, 3.0e-2, 1.5e-1, 1.5e-2,
                           5.0e-3, 3.0e-3, 3.0e-3, 4.0e-3, 8.0e-3, 5.0e-3,
                           1.5e-3, 4.0e-4, 1.5e-4, 6.0e-5, 1.5e-5, 3.0e-6,
                           2.0e-7]),
            'y': np.array([3.0e-3, 2.8e-3, 2.5e-3, 5.0e-3, 4.0e-2, 8.0e-3,
                           3.0e-3, 2.0e-3, 2.0e-3, 3.0e-3, 6.0e-3, 4.0e-3,
                           1.2e-3, 3.5e-4, 1.3e-4, 5.0e-5, 1.3e-5, 2.5e-6,
                           1.8e-7]),
            'z': np.array([1.3e-4, 1.3e-4, 1.5e-4, 3.0e-3, 1.3e-1, 1.2e-2,
                           4.0e-3, 2.5e-3, 2.5e-3, 3.5e-3, 7.0e-3, 4.5e-3,
                           1.3e-3, 3.5e-4, 1.3e-4, 5.0e-5, 1.3e-5, 2.5e-6,
                           1.8e-7]),
        },
        # узкополосные машинные/роторные гармоники, видные на графике
        # как острые пики поверх шумного "хвоста" 5-60 Гц; частоты/добротности
        # -- ориентировочные, подставьте реальные обороты вашей платформы
